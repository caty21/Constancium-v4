...
import { Calculator, TrendingUp, ArrowDown, Scale, Lock, ShieldCheck, Landmark } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          ...
          <div className="mb-12">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              >
                ...
                Effet levier
                {!isLeverageAuthenticated && <Lock className="h-3 w-3 opacity-60" />}
                <ArrowDown className="h-3 w-3" />
              </Button>
              <Button
                variant="outline"
              ...
              <Button
                variant="outline"
                className="border-primary/30 text-foreground hover:bg-primary hover:text-primary-foreground gap-2"
                onClick={() => scrollToSection("transmission-patrimoniale")}
                data-testid="button-nav-donation"
              >
                <Landmark className="h-4 w-4" />
                Transmission
                {!isDonationAuthenticated && <Lock className="h-3 w-3 opacity-60" />}
                <ArrowDown className="h-3 w-3" />
              </Button>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-16">
            <div className="bg-muted/30 p-8 rounded-lg border border-primary/10">
              ...
              <p className="text-foreground/80 leading-relaxed">
                La formule : <strong className="text-primary">Vf = Vi × (1 + r/n)^(n×t)</strong>
              </p>
            ...
            <div className="bg-muted/30 p-8 rounded-lg border border-primary/10">
              ...
              <p className="text-foreground/80 leading-relaxed mb-4">
                <strong>Exemple :</strong> 10 000 € à 7 %/an :
              </p>
              ...
              <p className="text-foreground/80 leading-relaxed mt-4">
                Capital multiplié par <strong className="text-primary">7,6</strong> en 30 ans.
              </p>
            </div>
          </div>
          ...
          <div id="effet-levier" className="mb-16 pt-8 scroll-mt-24">
            ...
            {isLeverageAuthenticated ? (
              ...
              <LockedSection onUnlock={() => setShowLeverageModal(true)} testId="button-unlock-leverage" />
            )}
          </div>
          ...
          <div id="transmission-patrimoniale" className="mb-16 pt-8 scroll-mt-24">
            <div className="flex items-center justify-between gap-3 mb-8 flex-wrap">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-serif text-3xl font-bold text-foreground" data-testid="text-donation-title">
                    Transmission &amp; Donation patrimoniale
                  </h2>
            ...
            {isDonationAuthenticated ? (
              ...
              <LockedSection onUnlock={() => setShowDonationModal(true)} testId="button-unlock-donation" />
            )}
          </div>
